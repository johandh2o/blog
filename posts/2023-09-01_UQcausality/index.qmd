...
[^1]: Some authors do not include $\mathcal{G}$ directly in $\mathcal{M}$, but say that $\mathcal{G}$ is *associated* with $\mathcal{M}$. This might be useful in some uncertainty-related context, such as when there are hidden variables, as many *marginal* graphs can be associated with the same SCM.
